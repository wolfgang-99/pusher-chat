...
# splitting to reconstruct the image link gotten
    ...
    return render_template("index.html", first_header= "wolrd", pic1=img_list[0],
                         pic2=img_list[1], pic3=img_list[2], pic4=img_list[3], pic5=img_list[4],
                           title1=title_list[0], title2=title_list[1], title3=title_list[2], title4=title_list[3], title5=title_list[4])
